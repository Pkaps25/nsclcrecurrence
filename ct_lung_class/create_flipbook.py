...
from datasets import getCtRawNodule, getNoduleInfoList, get_fixed_size_nodule
...
def process_nodules(output_dir, merged_pdf, datasets):
    ...
    for i, nod in enumerate(nodules):
        try:
            ...
            #     nod.file_path, nod.image_type, nod.center_lps, True, 15, [64] * 3, [64, 64, 64],
            #     seg_path=nod.seg_file
            # )[0]
            image = get_fixed_size_nodule(
                nod.file_path, nod.image_type, nod.center_lps, [65]*3, [65]*3,
